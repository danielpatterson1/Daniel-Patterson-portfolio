...
- **GitHub Pages** for deploying analytics portfolios

 

I enjoy transforming manual processes into **scalable, automated pipelines**, designing **executive‑ready dashboards**, and providing **clear, actionable insights** that help teams operate with confidence.
...
- Introduced a new **Executive Summary + KPI layout** now standard in multiple BSO reports.
